...
void protobuf_AssignDesc_First_2eHelloProto_2eproto() {
  protobuf_AddDesc_First_2eHelloProto_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "First.HelloProto.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_First_2eHelloProto_2eproto);
}
...
void protobuf_ShutdownFile_First_2eHelloProto_2eproto() {
  delete helloworld::default_instance_;
  delete helloworld_reflection_;
}

void protobuf_AddDesc_First_2eHelloProto_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\026First.HelloProto.proto\022\005First\"2\n\nhello"
    "world\022\n\n\002id\030\001 \002(\005\022\013\n\003str\030\002 \002(\t\022\013\n\003opt\030\003 "
    "\001(\005", 83);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "First.HelloProto.proto", &protobuf_RegisterTypes);
  helloworld::default_instance_ = new helloworld();
  helloworld::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_First_2eHelloProto_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_First_2eHelloProto_2eproto {
  StaticDescriptorInitializer_First_2eHelloProto_2eproto() {
    protobuf_AddDesc_First_2eHelloProto_2eproto();
  }
} static_descriptor_initializer_First_2eHelloProto_2eproto_;
...
helloworld::helloworld()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:First.helloworld)
}
...
helloworld::helloworld(const helloworld& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:First.helloworld)
}
...
helloworld::~helloworld() {
  // @@protoc_insertion_point(destructor:First.helloworld)
  SharedDtor();
}
...
const helloworld& helloworld::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_First_2eHelloProto_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:First.helloworld)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:First.helloworld)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:First.helloworld)
  return false;
#undef DO_
}
...
void helloworld::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:First.helloworld)
  // required int32 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_end:First.helloworld)
}

::google::protobuf::uint8* helloworld::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:First.helloworld)
  // required int32 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:First.helloworld)
  return target;
}
