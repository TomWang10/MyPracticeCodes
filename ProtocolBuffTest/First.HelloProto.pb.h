...
#ifndef PROTOBUF_First_2eHelloProto_2eproto__INCLUDED
#define PROTOBUF_First_2eHelloProto_2eproto__INCLUDED
...
class helloworld : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:First.helloworld)
 private:
  ...
  friend void  protobuf_AddDesc_First_2eHelloProto_2eproto();
  friend void protobuf_AssignDesc_First_2eHelloProto_2eproto();
  friend void protobuf_ShutdownFile_First_2eHelloProto_2eproto();
...
inline ::google::protobuf::int32 helloworld::id() const {
  // @@protoc_insertion_point(field_get:First.helloworld.id)
  return id_;
}
inline void helloworld::set_id(::google::protobuf::int32 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:First.helloworld.id)
}
...
inline const ::std::string& helloworld::str() const {
  // @@protoc_insertion_point(field_get:First.helloworld.str)
  return *str_;
}
inline void helloworld::set_str(const ::std::string& value) {
  ...
  str_->assign(value);
  // @@protoc_insertion_point(field_set:First.helloworld.str)
}
inline void helloworld::set_str(const char* value) {
  ...
  str_->assign(value);
  // @@protoc_insertion_point(field_set_char:First.helloworld.str)
}
inline void helloworld::set_str(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:First.helloworld.str)
}
inline ::std::string* helloworld::mutable_str() {
  ...
  // @@protoc_insertion_point(field_mutable:First.helloworld.str)
  return str_;
}
...
inline void helloworld::set_allocated_str(::std::string* str) {
  ...
  // @@protoc_insertion_point(field_set_allocated:First.helloworld.str)
}
...
inline ::google::protobuf::int32 helloworld::opt() const {
  // @@protoc_insertion_point(field_get:First.helloworld.opt)
  return opt_;
}
inline void helloworld::set_opt(::google::protobuf::int32 value) {
  set_has_opt();
  opt_ = value;
  // @@protoc_insertion_point(field_set:First.helloworld.opt)
}
...
#endif  // PROTOBUF_First_2eHelloProto_2eproto__INCLUDED
